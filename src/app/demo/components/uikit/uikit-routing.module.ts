...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'productos', data: { breadcrumb: 'List' }, loadChildren: () => import('./list/listdemo.module').then(m => m.ListDemoModule) },
        ...
        { path: 'providers', data: { breadcrumb: 'Table' }, loadChildren: () => import('./providertable/providertable.module').then(m => m.ProviderTableModule) },
        ...
        { path: 'perfil', data: { breadcrumb: 'Menu' }, loadChildren: () => import('./perfil/perfil.module').then(m => m.PerfilModule) },
